      ...
      <footer className="bg-gray-900/80 backdrop-blur-md text-white py-16 px-6">
        <div className="max-w-7xl mx-auto">
          <div className="flex flex-col md:flex-row justify-between items-center">
            ...
            >
             <a href="https://www.nurullahmencik.com/" target="_blank" rel="noopener noreferrer" className="text-2xl font-bold bg-clip-text text-transparent bg-gradient-to-r from-amber-400 to-amber-600 cursor-pointer block hover:scale-105 transition-transform duration-300">
                Nurullah Mencik
              </a>
