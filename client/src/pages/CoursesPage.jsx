...
const CoursesPage = () => {
  ...
  useEffect(() => {
    console.log('🔄 CoursesPage yükleniyor, kurslar getiriliyor...');
    dispatch(getCourses());
  }, [dispatch]);
    ...
    <div className="min-h-screen bg-[#1a202c] text-white py-10 px-4 sm:px-6 overflow-x-hidden">
      ...
      <div className="max-w-7xl mx-auto flex flex-col md:flex-row gap-6">
        ...
        <div className="flex-1">
          ...
          {error && (
            <div className="text-center text-red-400 font-semibold text-xl bg-red-900/20 p-6 rounded-lg border border-red-500">
              <p className="mb-2">❌ Kurslar alınamadı</p>
              <p className="text-sm text-gray-300 mb-4">{error.message || 'Bilinmeyen bir hata oluştu'}</p>
              <button 
